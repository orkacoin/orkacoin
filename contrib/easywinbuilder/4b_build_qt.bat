...
@set QMPS=BOOST_INCLUDE_PATH=%EWBLIBS%/%BOOST%^
 BOOST_LIB_PATH=c:/suncoin5/libs/%BOOST%/stage/lib^
 BOOST_LIB_SUFFIX=%BOOSTSUFFIX%^
 OPENSSL_INCLUDE_PATH=c:/suncoin5/libs/include^
 OPENSSL_LIB_PATH=c:/suncoin5/libs/%OPENSSL%^
 BDB_INCLUDE_PATH=c:/suncoin5/libs/%BERKELEYDB%/build_unix^
 BDB_LIB_PATH=c:/suncoin5/libs/%BERKELEYDB%/build_unix^
 MINIUPNPC_INCLUDE_PATH=c:/suncoin5/libs/%MINIUPNPC%^
 MINIUPNPC_LIB_PATH=c:/suncoin5/libs/%MINIUPNPC%^
...
mingw32-make -f Makefile.Release USE_UPNP=-
